...
<<setup, echo = FALSE>>=
Month <- "Apr"                                     # update trend builder below
Year <- 2020
DivFile <- "../data/Div First Pass Acceptance.csv"
XLabel <- "Since November 2018"
@
...
DivPlotData <- getResultsCHaRM(Month = "Nov",
                        Year = 2018,
                        File = DivFile)
