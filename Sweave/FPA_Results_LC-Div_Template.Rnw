...
Year <- 2021
XLabel <- "Since September 2019"                                                # Update for period
...
DivPlotData <- getResults(Month = "Sep",
                        Year = 2019,
                        File = DivFile)
...
Acceptance.xlsx''.\footnote{data is stored on the dept 09HD share drive} This
is for the month of \reportMonth \, \reportYear.\footnote{Date Ran: \today{} at \currenttime}
\end{abstract}
