...
%
\newcommand{\reportMonth}{February} %        <<< UPDATE
...
XLabel <- "Since September 2019"                              # update each month
@
...
DivPlotData <- getResultsCombined(Month = "Sep",
                           Year = 2019,
                           File1 = file1,
                           File2 = file2,
                           File3 = file3)
...
Acceptance.xlsx'', ``First Pass Acceptance Dallas.xlsx" and
``First Pass Acceptance_Wiesbaden.xlsx''.\footnote{data is stored on the dept 09HD share drive}
...
from September 2019 and the Wiesbaden team starting from January 2020.
