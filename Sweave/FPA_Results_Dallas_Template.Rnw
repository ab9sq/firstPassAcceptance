...
Year <- 2021
XLabel <-  "Since Sepember 2019"                                                    # update
...
Acceptance_Dallas.xlsx''. \footnote{data is stored on the dept 09HD share drive}
...
Trend graphs reflect the past 3 months of data.                         % UPDATE

% No trending chart at this time due to lack of data.
