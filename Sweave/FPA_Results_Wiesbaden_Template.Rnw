...
Year <- 2021
XLabel <- "Since Jan 2020"                                                            # status until july 2021 (?)
...
# # for update:
# #                   No intial upupdates (steps 1-3) until Aug 2021 (?) For 18 months of data
...
the Excel workbook that Software Quality Assurance collected called ``First
Pass Acceptance\_Wiesbaden.xlsx''.\footnote{data is stored on the dept 09HD share drive}
...
Trend graphs reflect the past 14 months of data.                % UPDATE number of months until equal 18.
